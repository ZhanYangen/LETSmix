...
class Args():
    def __init__(self):
        ...
        self.bs = {'source':1024, 'target':1024, 'target_mix':1024}
        self.beta = 2
        self.weight = {'target':1, 'target_mix':0, 'domain':1, 'reg':0}
        self.stage1 = {'interval':100, 'ite':2001}  # pretrain the source classifier
        self.stage2 = {'interval':100, 'ite':8001, 'reg':2000}  # adversarial training for both classifiers
        ...
        self.st = ['151673.h5ad']
        self.logdir = '/home/zhanyg/Code/LETSmix/code/DLPFC/log/test2/base2/t2/'
...
def main():
    ...
    print(fnum, f'mean ER {np.mean(num):.4f}')
